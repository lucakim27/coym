  ...
  <div class='container' v-if="!isMobile()">
    <div class="onlineDiv" :style="mobileCheck">
      <div class="onlineHead" v-if="!isMobile()">
        ...
        <div><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" class="bi bi-gender-ambiguous"
            viewBox="0 0 16 16">
            <path fill-rule="evenodd"
        ...
        <div><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" viewBox="0 0 512 512">
        ...
        <div><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" viewBox="0 0 512 512">
            ...
            <polygon points="32 192 256 64 480 192 256 320 32 192"
              style="fill:rgb(146, 156, 161);stroke:white;stroke-linecap:round;stroke-linejoin:round;stroke-width:32px" />
        ...
        <div><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" data-name="Layer 1"
            viewBox="0 0 24 24">
            <path
      ...
      <div class="onlineBody mobileBody">
        <div v-for="user in users" :key="user.username">
          <div class='eachRow'>
            <div class="row">
              <div><a class="mobileUsername">{{ user.username }}</a></div>
      ...
      <div class="mostViewedPages">
        <div class='eachRow' v-for="user in users" :key="user.username">
          <p class="alignChild">
            ...
            <a class="mobileUsername">{{ user.username }}</a>
          </p>
          <p class="alignChild">
