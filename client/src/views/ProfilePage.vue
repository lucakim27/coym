                        ...
                        <a v-if="userDetails !== null" class="profileUserDetailsDesktopContainer">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                    height="30" fill="white" class="bi bi-gender-ambiguous"
                                    viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                ...
                                <p v-if="userDetails.gender !== null && userDetails.gender !== ''">{{ userDetails.gender }}</p>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                    height="30" fill="white" viewBox="0 0 512 512">
                                ...
                                <p v-if="userDetails.country !== null && userDetails.country !== ''">{{ userDetails.country }}</p>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                    height="30" fill="white" viewBox="0 0 512 512">
                                ...
                                <p v-if="userDetails.major !== null && userDetails.major !== ''">{{ userDetails.major }}</p>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                    height="30" fill="white" data-name="Layer 1" viewBox="0 0 24 24">
                                    <path
                                ...
                                <p v-if="userDetails.school !== null && userDetails.school !== ''">{{ userDetails.school }}</p>
                            </div>
                        </a>
                    </div>
                    </div>
