        ...
        <div style="height: 1200px; text-align: center;">
            ...
            <div style='position: absolute; top: 100%; margin-left: auto; margin-right: auto; left: 0; right: 0; text-align: center;'>
                <div>
                    ...
                    <path d="M45.4,177A95.9,95.9,0,1,1,79,210.6h0L45.8,220a7.9,7.9,0,0,1-9.8-9.8L45.4,177Z" fill="none"
                        stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></path>
                    <line x1="96" y1="108" x2="160" y2="108" fill="none" stroke="#000" stroke-linecap="round"
                        stroke-linejoin="round" stroke-width="24"></line>
                    <line x1="96" y1="148" x2="160" y2="148" fill="none" stroke="#000" stroke-linecap="round"
                        stroke-linejoin="round" stroke-width="24"></line>
                    ...
                    <svg style="margin: 20px;" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                        fill="currentColor" class="bi bi-text-paragraph" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                    ...
                    <svg style="margin: 20px;" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
                        fill="currentColor" class="bi bi-mailbox" viewBox="0 0 16 16">
                        <path
