<template>
    <div class='homeContainer'>
        ...
        <div class='homeDescriptionContainer' :style="mobileDescription">
            <div>
                <svg @click="renderPages('/')" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white" class="bi bi-house"
                    viewBox="0 0 16 16">
                ...
                <svg @click="renderPages('/people')" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white"
                ...
                <svg @click="focusInput()" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white"
                ...
                <svg @click="renderPages('/chart')" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white"
                    class="bi bi-bar-chart-line" viewBox="0 0 16 16">
                    <path
                        d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z" />
                </svg>
                <svg @click="renderPages('/aboutUs')" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white"
                ...
                <svg onclick="window.location.href = 'mailto:nikolaikim27@gmail.com'" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white"
