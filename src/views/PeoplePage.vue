    ...
    <div class="userOnlineDiv" :style="mobileCheck">
      <div class="userOnlineHead" v-if="!isMobile()">
        ...
        <div><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
              id="Layer_1" x="0px" y="0px" width="40" height="40" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; margin-top: -3px;"
              xml:space="preserve">
              <g>
                <g>
        ...
        <div class='userEachRow' v-for="user in filteredUsersList" :key="user.username">
          ...
          <p class="userAlignChild">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
              id="Layer_1" x="0px" y="0px" width="30" height="30" fill="white" viewBox="0 0 512 512" style="margin-top: -5px;enable-background:new 0 0 512 512;"
              xml:space="preserve">
              <g>
                <g>
                  <rect y="478.609" width="512" height="33.391" />
