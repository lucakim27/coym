<template>
    <div id='container'>
      <div id="ipnutContainer">
        ...
        <textarea height="60" type="text" id="userInput" v-model="commentInput" v-if="majorName !== null"
          :placeholder="'Comment on ' + majorName + ' module...'" @focus="showBtns = true"></textarea><br>
  ...
  export default {
    ...
    methods: {
      getMajorName(self) {
        axios({
          method: "GET",
          url: `${process.env.VUE_APP_ROOT_API}/getModuleName/${this.$route.params.id}`
      ...
      initComment(self) {
        axios({
          method: "GET",
          url: `${process.env.VUE_APP_ROOT_API}/getModuleComment/${this.$route.params.id}`
        }).then(function (response) {
      ...
      initLike(self) {
        axios({
          method: "GET",
          url: `${process.env.VUE_APP_ROOT_API}/getModuleLike/${this.$route.params.id}`
        }).then(function (response) {
          if (response.data.status) {
      ...
      initReply(self) {
        axios({
          method: "GET",
          url: `${process.env.VUE_APP_ROOT_API}/getModuleReply/${this.$route.params.id}`
        }).then(function (response) {
          if (response.data.status) {
      ...
      editComment(commentID) {
        if (document.getElementById(`editTextArea/${commentID}`).value === '') {
          ...
          axios({
            method: "POST",
            url: `${process.env.VUE_APP_ROOT_API}/editModuleComment/${commentID}`,
      ...
      editReplyBtn(replyID, commentID) {
        if (document.getElementById(`replyEditTextArea/${commentID}/${replyID}`).value === '') {
          ...
          axios({
            method: "POST",
            url: `${process.env.VUE_APP_ROOT_API}/editModuleReply/${replyID}`,
            headers: { 'Content-Type': 'application/json' },
      ...
      deleteComment(commentID) {
        if (confirm("Are you sure you want to delete the comment?")) {
          axios({
            method: "POST",
            url: `${process.env.VUE_APP_ROOT_API}/deleteModuleComment/${commentID}`,
            headers: { 'Content-Type': 'application/json' }
          }).then(function (response) {
            if (response.data.status) {
      ...
      deleteReply(replyID) {
        if (confirm("Are you sure you want to delete the reply?")) {
          axios({
            method: "POST",
            url: `${process.env.VUE_APP_ROOT_API}/deleteModuleReply/${replyID}`,
            headers: { 'Content-Type': 'application/json' }
          }).then(function (response) {
            if (response.data.status) {
      ...
      reply(commentID) {
        if (this.username === '' || this.username === null) {
          ...
          axios({
            method: "POST",
            url: `${process.env.VUE_APP_ROOT_API}/postModuleReply/${commentID}`,
            headers: { 'Content-Type': 'application/json' },
      ...
      comment() {
        if (this.username === '' || this.username === null) {
          ...
          axios({
            method: "POST",
            url: `${process.env.VUE_APP_ROOT_API}/postModuleComment/${this.$route.params.id}`,
            headers: { 'Content-Type': 'application/json' },
      ...
      likeComment(commentID) {
        if (this.username === '' || this.username === null) {
          ...
          axios({
            method: "POST",
            url: `${process.env.VUE_APP_ROOT_API}/postModuleLike/${commentID}`,
            headers: { 'Content-Type': 'application/json' },
